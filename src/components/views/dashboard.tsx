      ...
      <div className="max-w-md mx-auto px-5 pb-24 pt-8">
        <header className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="p-2 rounded-full bg-slate-200 dark:bg-slate-800 text-slate-900 dark:text-slate-100 hover:bg-slate-300 dark:hover:bg-slate-700" aria-label="Settings">
        ...
        <section className="card p-5 text-slate-900 bg-accent">
          ...
          <p className="text-xs mt-2 text-slate-900/80">Auto-switch at 20 min</p>
          <p className="text-xs text-slate-900/80">Auto-stop second side at 20 min</p>
        </section>

        <section className="mt-5">
          <h3 className="text-sm font-semibold text-slate-600 dark:text-slate-300 mb-3">Quick Add</h3>
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              >
                <span className="p-2 rounded-xl bg-slate-100 dark:bg-slate-900/50 text-accent">{item.icon}</span>
        ...
        <section className="card mt-5 p-4 text-slate-900 dark:text-slate-50">
          <p className="text-sm text-slate-500 dark:text-slate-400">Today&apos;s Totals</p>
          <div className="grid grid-cols-3 gap-4 mt-3">
            <div>
              <p className="text-2xl font-bold">{mockTotals.feeds}</p>
              <p className="text-xs text-slate-500 dark:text-slate-400">Feeds</p>
            </div>
            <div>
              <p className="text-2xl font-bold">{mockTotals.diapers}</p>
              <p className="text-xs text-slate-500 dark:text-slate-400">Diapers</p>
            </div>
            <div>
        ...
        <section className="mt-6">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-slate-600 dark:text-slate-300">History</h3>
            <button className="text-xs text-accent">Filter</button>
          </div>
          <div className="space-y-3">
            {mockHistory.map((item, idx) => (
              <div key={idx} className="card p-4 text-slate-900 dark:text-slate-50 flex items-start gap-3">
          ...
          <div className="max-w-md mx-auto flex justify-around py-3 text-slate-600 dark:text-slate-300">
            {[
              ...
              <a key={item.label} href={item.href} className="flex flex-col items-center gap-1 text-sm">
                <span className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800/80 text-accent">{item.icon}</span>
